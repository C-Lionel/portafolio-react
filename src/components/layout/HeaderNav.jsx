...
export const HeaderNav = () => {
    ...
    return (
        ...
        <header className='header'>
            ...
            <NavLink onClick={handleNavLinkClick} to="/"> <img className='logo' src="../assets/imgs/logo.png" alt="logo" />  </NavLink>
            ...
            <button className="btn button-canva d-block d-sm-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
                {
